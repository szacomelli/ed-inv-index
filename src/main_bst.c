...
BinaryTree* buildTree(string** docInfo, string mode) {
    system("mkdir stats");
    FILE *insertWordsCSV = fopen("./stats/bst_word_inserts.csv", "w");
    FILE *insertDocCSV = fopen("./stats/bst_doc_inserts.csv", "w");
    FILE *insertCSV = fopen("./stats/bst_total_inserts.csv", "w");
    clock_t start = clock();
...
void getSearchInfo(string** docInfo, BinaryTree* tree) {
  FILE *searchCSV = fopen("./stats/bst_total_search.csv", "w");
  FILE *searchWordCSV = fopen("./stats/bst_word_search.csv", "w");
  FILE *searchDocCSV = fopen("./stats/bst_doc_search.csv", "w");
  clock_t start = clock();
